          ...
          <div className="row g-5">
            ...
            <div className="col-12 col-lg-4">
              ...
              <div className="d-flex gap-3">
                <a href="#facebook" aria-label="BeatBox on Facebook" className="btn btn-outline-secondary p-2 rounded-circle hover-scale text-theme-muted hover-text-white border-secondary border-opacity-25" style={{ transition: 'all 0.3s', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                </a>
                <a href="#instagram" aria-label="BeatBox on Instagram" className="btn btn-outline-secondary p-2 rounded-circle hover-scale text-theme-muted hover-text-white border-secondary border-opacity-25" style={{ transition: 'all 0.3s', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                <a href="#twitter" aria-label="BeatBox on Twitter" className="btn btn-outline-secondary p-2 rounded-circle hover-scale text-theme-muted hover-text-white border-secondary border-opacity-25" style={{ transition: 'all 0.3s', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <a href="#youtube" aria-label="BeatBox on YouTube" className="btn btn-outline-secondary p-2 rounded-circle hover-scale text-theme-muted hover-text-white border-secondary border-opacity-25" style={{ transition: 'all 0.3s', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div className="col-6 col-md-3 col-lg-2 ms-lg-auto">
              ...
              <ul className="list-unstyled d-flex flex-column gap-3 small">
                <li><Link to="/products?category=true wireless earbuds" className="text-theme-muted text-decoration-none transition-all">True Wireless Earbuds</Link></li>
                <li><Link to="/products?category=wireless headphones" className="text-theme-muted text-decoration-none transition-all">Wireless Headphones</Link></li>
                <li><Link to="/products?category=neckbands" className="text-theme-muted text-decoration-none transition-all">Wireless Neckbands</Link></li>
                <li><Link to="/products?category=speakers" className="text-theme-muted text-decoration-none transition-all">Bluetooth Speakers</Link></li>
                <li><Link to="/products?category=gaming" className="text-theme-muted text-decoration-none transition-all">Wired & Gaming Gear</Link></li>
                <li><Link to="/products?category=powerbanks" className="text-theme-muted text-decoration-none transition-all">Power Banks</Link></li>
              </ul>
            </div>
            ...
            <div className="col-6 col-md-3 col-lg-2">
              ...
              <ul className="list-unstyled d-flex flex-column gap-3 small">
                ...
                <li><Link to="/orders" className="text-theme-muted text-decoration-none transition-all">Track Your Order</Link></li>
                <li><Link to="/warranty" className="text-theme-muted text-decoration-none transition-all">Warranty Claim</Link></li>
                <li><Link to="/returns" className="text-theme-muted text-decoration-none transition-all">Return & Exchanges</Link></li>
                <li><Link to="/faq" className="text-theme-muted text-decoration-none transition-all">FAQs & Guides</Link></li>
              </ul>
            </div>
            ...
            <div className="col-12 col-sm-6 col-md-3 col-lg-2">
              ...
              <ul className="list-unstyled d-flex flex-column gap-3 small">
                <li><Link to="/about" className="text-theme-muted text-decoration-none transition-all">About BeatBox</Link></li>
                ...
                <li><Link to="/careers" className="text-theme-muted text-decoration-none transition-all">Careers</Link></li>
              </ul>
            </div>
