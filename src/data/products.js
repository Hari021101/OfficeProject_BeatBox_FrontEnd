...
import carBluetoothAdapterImage from '../assets/car_bluetooth_adapter.png'
import beatboxSmartTagImage from '../assets/beatbox_smart_tag.png'
import twsEarbudsProImage from '../assets/tws_earbuds_pro.png'
...
export const IMAGE_MAP = {
  ...
  pendriveFlashImage,
  microsdCardImage,
  carBluetoothAdapterImage,
  beatboxSmartTagImage,
  twsEarbudsProImage,
  usbGamingSpeakersImage,
  partySpeakerImage,
  wirelessMicImage
}
...
export const CATEGORIES = [
  ...
  { id: 'soundbars', label: 'Soundbars', emoji: '📺' },
  ...
  { id: 'wireless headphones', label: 'Wireless Headphones', emoji: '🎧' },
  ...
  { id: 'keyboard and mouse', label: 'Keyboard And Mouse', emoji: '⌨️' },
  { id: 'laptop stand', label: 'Laptop Stand', emoji: '💻' },
  ...
  { id: 'car charger', label: 'Car Chargers', emoji: '⚡' },
  ...
  { id: 'car wireless charger', label: 'Car Wireless Chargers', emoji: '⚡' },
  ...
  { id: 'mobile holder', label: 'Mobile Holder', emoji: '📱' },
  { id: 'wireless charger', label: 'Wireless Charger', emoji: '⚡' },
  { id: 'usb hub', label: 'USB Hub', emoji: '🔌' },
  { id: 'laptop bags', label: 'Laptop Bags', emoji: '💼' },
  { id: 'tyre inflator', label: 'Tyre Inflator', emoji: '🚗' },
  { id: 'vacuum cleaner', label: 'Vacuum Cleaner', emoji: '🧹' },
  { id: 'portable fans', label: 'Portable Fans', emoji: '💨' },
  { id: 'selfie stick', label: 'Selfie Stick', emoji: '📸' },
  { id: 'flashlight', label: 'Flashlight', emoji: '🔦' },
  { id: 'stylus', label: 'Stylus', emoji: '🖊️' },
  { id: 'location tracker', label: 'Location tracker', emoji: '📍' },
  { id: 'electric kettle', label: 'Electric Kettle', emoji: '☕' },
  { id: 'hair dryer', label: 'Hair Dryer', emoji: '💇' },
  { id: 'ssd cards', label: 'SSD Cards', emoji: '💾' },
  { id: 'pendrives', label: 'Pendrives', emoji: '💾' },
  { id: 'hard disks', label: 'Hard Disks', emoji: '💽' },
  { id: 'memory cards', label: 'Memory Cards', emoji: '💾' },
  { id: 'calculators', label: 'Calculators', emoji: '🧮' },
  { id: 'smart tag', label: 'Smart Tag', emoji: '🏷️' },
  { id: 'camera', label: 'Camera', emoji: '📹' },
  { id: 'video door phone', label: 'Video Door Phone', emoji: '🚪' },
  { id: 'video recorder', label: 'Video Recorder', emoji: '📼' },
  { id: 'poe devices', label: 'PoE Devices', emoji: '🔌' },
  { id: 'vehicle surveillance', label: 'Vehicle Surveillance', emoji: '🚓' },
  { id: 'accessories', label: 'Accessories', emoji: '⚙️' },
  { id: 'smart wifi plug', label: 'Smart Wifi Plug', emoji: '🔌' },
  { id: 'smart wifi cameras', label: 'Smart WiFi Cameras', emoji: '📷' },
  { id: 'smart wifi universal remote', label: 'Smart Remote', emoji: '📱' },
  { id: 'latest drops', label: 'Latest Drops', emoji: '🔥' },
  { id: 'trending gear', label: 'Trending Gear', emoji: '📈' },
  { id: 'upcoming releases', label: 'Upcoming Releases', emoji: '📅' },
  { id: 'limited editions', label: 'Limited Editions', emoji: '🌟' },
  { id: 'wifi speakers', label: 'Wifi Speakers', emoji: '🔊' }
]
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    imageKey: 'beatboxSmartTagImage', badge: 'Never Lose', inStock: true,
  ...
  { id: 72, slug: 'party-boom', name: 'Party Boom 1500', brand: 'BeatBox', category: 'party speakers', price: 12999, oldPrice: 24999, discount: 48, rating: 4.8, reviewCount: 290, tag: 'Loud', usp: '1500W Peak', imageKey: 'partySpeakerImage', badge: 'Beast', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Power': '1500W Peak', 'Battery': '8 Hours'}, description: 'Massive party speaker with 1500W peak power and built-in disco lights.', highlights: ['Disco Lights', 'Mic Input'], reviews: [] },
  { id: 73, slug: 'party-blast', name: 'Party Blast Tower', brand: 'BeatBox', category: 'party speakers', price: 14999, oldPrice: 29999, discount: 50, rating: 4.9, reviewCount: 180, tag: 'Tower', usp: 'Tower Speaker', imageKey: 'partySpeakerImage', badge: 'Epic', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Height': '1.2m', 'Power': '800W'}, description: 'Tall tower party speaker with a karaoke mic and FM radio.', highlights: ['Karaoke Ready', 'FM Radio'], reviews: [] },
  { id: 74, slug: 'party-max', name: 'Party Max 2000', brand: 'BeatBox', category: 'party speakers', price: 18999, oldPrice: 39999, discount: 52, rating: 4.9, reviewCount: 120, tag: 'Pro', usp: '2000W RMS', imageKey: 'partySpeakerImage', badge: 'King', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Power': '2000W RMS'}, description: 'Professional-grade party speaker for outdoor events and large gatherings.', highlights: ['Outdoor Ready', 'Dual Woofer'], reviews: [] },
  { id: 75, slug: 'party-lite', name: 'Party Lite Wireless', brand: 'BeatBox', category: 'party speakers', price: 7999, oldPrice: 16999, discount: 52, rating: 4.6, reviewCount: 410, tag: 'Portable', usp: 'Wireless', imageKey: 'partySpeakerImage', badge: 'Portable', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Battery': '12 Hours', 'Power': '60W'}, description: 'Portable party speaker with 12-hour battery and splash resistance.', highlights: ['IPX5 Splash Proof', 'Carry Handle'], reviews: [] },
  ...
  { id: 94, slug: 'usb-speakers-rgb', name: 'USB RGB Gaming Speakers', brand: 'BeatBox', category: 'usb speakers', price: 1299, oldPrice: 2999, discount: 56, rating: 4.7, reviewCount: 430, tag: 'RGB', usp: 'RGB Lighting', imageKey: 'usbGamingSpeakersImage', badge: 'Gamer', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Power': '10W RMS', 'Lighting': 'RGB'}, description: 'USB gaming speakers with vibrant RGB lighting and punchy bass.', highlights: ['RGB Lighting', 'Headphone Jack'], reviews: [] },
  { id: 95, slug: 'usb-speakers-pro', name: 'USB Studio Monitors', brand: 'BeatBox', category: 'usb speakers', price: 1999, oldPrice: 4499, discount: 55, rating: 4.8, reviewCount: 220, tag: 'Studio', usp: 'Flat Response', imageKey: 'usbGamingSpeakersImage', badge: 'Creator', inStock: true, colors: [{name: 'White', code: '#fff'}], specs: {'Power': '20W RMS', 'Response': 'Flat'}, description: 'USB studio monitor speakers for accurate audio mixing and content creation.', highlights: ['Flat Frequency', 'XLR Input'], reviews: [] },
  { id: 96, slug: 'usb-speakers-mini', name: 'USB Mini Desktop Speakers', brand: 'BeatBox', category: 'usb speakers', price: 699, oldPrice: 1699, discount: 58, rating: 4.5, reviewCount: 760, tag: 'Mini', usp: 'Bus Powered', imageKey: 'usbGamingSpeakersImage', badge: 'Compact', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Power': '5W RMS', 'Powered': 'USB Bus'}, description: 'No power adapter needed. Just plug into your PC and enjoy clear desktop audio.', highlights: ['Bus Powered', 'Volume Knob'], reviews: [] },
  { id: 97, slug: 'usb-speakers-soundbar', name: 'USB Desktop Soundbar', brand: 'BeatBox', category: 'usb speakers', price: 1499, oldPrice: 3499, discount: 57, rating: 4.6, reviewCount: 310, tag: 'Soundbar', usp: 'Under Monitor', imageKey: 'usbGamingSpeakersImage', badge: 'Space Saver', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Power': '15W RMS', 'Form': 'Under-Monitor'}, description: 'Slim USB soundbar designed to sit neatly under your monitor.', highlights: ['Space-Saving Design', 'Optical Input'], reviews: [] },
  ...
  { id: 102, slug: 'mic-handheld', name: 'Wireless Handheld Mic', brand: 'BeatBox', category: 'wireless microphones', price: 5999, oldPrice: 12999, discount: 53, rating: 4.8, reviewCount: 180, tag: 'Stage', usp: 'Stage Ready', imageKey: 'wirelessMicImage', badge: 'Live', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Range': '80m', 'Battery': '10 Hours'}, description: 'Professional wireless handheld mic for live performances and events.', highlights: ['80m Range', 'Anti-Drop Design'], reviews: [] },
  { id: 103, slug: 'mic-lavalier', name: 'Wireless Lavalier Clip Mic', brand: 'BeatBox', category: 'wireless microphones', price: 3499, oldPrice: 7999, discount: 56, rating: 4.7, reviewCount: 390, tag: 'Vlog', usp: 'Clip-On Design', imageKey: 'wirelessMicImage', badge: 'Creator', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Latency': '20ms', 'Battery': '8 Hours'}, description: 'Wireless clip-on lavalier mic for vloggers and content creators.', highlights: ['Clip-On Design', 'Noise Shield'], reviews: [] },
  { id: 104, slug: 'mic-duo', name: 'Wireless Dual Mic System', brand: 'BeatBox', category: 'wireless microphones', price: 8999, oldPrice: 19999, discount: 55, rating: 4.9, reviewCount: 95, tag: 'Dual', usp: '2-Person Recording', imageKey: 'wirelessMicImage', badge: 'Interview', inStock: true, colors: [{name: 'Black', code: '#000'}], specs: {'Channels': 'Dual', 'Range': '100m'}, description: 'Dual wireless mic system ideal for interviews and two-person podcasts.', highlights: ['Dual Channel', 'Mixer Output'], reviews: [] },
  { id: 105, slug: 'mic-studio', name: 'Studio Wireless Condenser', brand: 'BeatBox', category: 'wireless microphones', price: 12999, oldPrice: 27999, discount: 53, rating: 4.9, reviewCount: 60, tag: 'Studio', usp: 'Condenser Grade', imageKey: 'wirelessMicImage', badge: 'Pro Audio', inStock: true, colors: [{name: 'Silver', code: '#c0c0c0'}], specs: {'Type': 'Condenser', 'Freq': '20Hz-20kHz'}, description: 'Premium wireless condenser microphone for studio-quality recordings.', highlights: ['Condenser Capsule', 'Low Self-Noise'], reviews: [] },
  ...
  {
    id: 199,
    slug: 'beatbox-rockerz-prime-205',
  ...
  {
    id: 205,
    slug: 'beatbox-rockerz-prime-255z',
  ...
  {
    id: 237,
    slug: 'beatbox-immortal-katana-blade-2-0',
  ...
  {
    id: 286,
    slug: 'beatbox-stone-arc-pro-plus',
  ...
  {
    id: 303,
    slug: 'beatbox-stone-350-pro-naruto-edition',
  ...
  {
    id: 312,
    slug: 'beatbox-rockerz-425',
    name: 'BeatBox Rockerz 425',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3715,
    oldPrice: 9182,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 425. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 313,
    slug: 'beatbox-rockerz-411',
    name: 'BeatBox Rockerz 411',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1802,
    oldPrice: 5201,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 411. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 314,
    slug: 'beatbox-rockerz-plus-450-anc',
    name: 'BeatBox Rockerz Plus 450 ANC',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3598,
    oldPrice: 5781,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz Plus 450 ANC. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 315,
    slug: 'beatbox-nirvana-751-anc',
    name: 'BeatBox Nirvana 751 ANC',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1272,
    oldPrice: 4705,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Nirvana 751 ANC. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 316,
    slug: 'beatbox-rockerz-plus-550-anc',
    name: 'BeatBox Rockerz Plus 550 ANC',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2968,
    oldPrice: 7995,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz Plus 550 ANC. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 317,
    slug: 'beatbox-bassheads-900',
    name: 'BeatBox Bassheads 900',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3796,
    oldPrice: 8100,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Bassheads 900. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 318,
    slug: 'beatbox-rockerz-prime-415',
    name: 'BeatBox Rockerz Prime 415',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1404,
    oldPrice: 5884,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz Prime 415. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 319,
    slug: 'bassheads-901-pro',
    name: 'Bassheads 901 Pro',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3940,
    oldPrice: 7124,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the Bassheads 901 Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 320,
    slug: 'beatbox-rockerz-551-anc-pro',
    name: 'BeatBox Rockerz 551 ANC Pro',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2970,
    oldPrice: 7086,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 551 ANC Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 321,
    slug: 'beatbox-rockerz-trendz',
    name: 'BeatBox Rockerz Trendz',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2471,
    oldPrice: 7022,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz Trendz. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 322,
    slug: 'bassheads-900-c-pro',
    name: 'Bassheads 900 C Pro',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3261,
    oldPrice: 7143,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the Bassheads 900 C Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  },
  {
    ...
    description: 'Experience immersive BeatBox Signature Sound with the Bassheads 900 Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 325,
    slug: 'beatbox-rockerz-460-naruto-edition',
    name: 'BeatBox Rockerz 460 Naruto Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1159,
    oldPrice: 5075,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 460 Naruto Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 326,
    slug: 'nirvana-eutopia-dhruv-kapoor-edition',
    name: 'Nirvana Eutopia - Dhruv Kapoor Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3962,
    oldPrice: 6838,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the Nirvana Eutopia - Dhruv Kapoor Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 328,
    slug: 'beatbox-rockerz-400-pro',
    name: 'BeatBox Rockerz 400 Pro',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3835,
    oldPrice: 8882,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 400 Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 329,
    slug: 'beatbox-nirvana-eutopia',
    name: 'BeatBox Nirvana Eutopia',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2897,
    oldPrice: 8018,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Nirvana Eutopia. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 330,
    slug: 'beatbox-rockid-rush',
    name: 'BeatBox Rockid Rush',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1957,
    oldPrice: 6829,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockid Rush. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 331,
    slug: 'beatbox-rockerz-551anc',
    name: 'BeatBox Rockerz 551ANC',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2086,
    oldPrice: 5752,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 551ANC. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 332,
    slug: 'beatbox-rockerz-558-sunburn-edition',
    name: 'BeatBox Rockerz 558 Sunburn Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3334,
    oldPrice: 5081,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 558 Sunburn Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 333,
    slug: 'beatbox-rockerz-650-sunburn-edition',
    name: 'BeatBox Rockerz 650 Sunburn Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2780,
    oldPrice: 6280,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 650 Sunburn Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 334,
    slug: 'beatbox-rockerz-650-dc-edition',
    name: 'BeatBox Rockerz 650 DC Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1547,
    oldPrice: 3562,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 650 DC Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 335,
    slug: 'beatbox-rockerz-450r',
    name: 'BeatBox Rockerz 450R',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2266,
    oldPrice: 5603,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450R. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 336,
    slug: 'beatbox-immortal-300',
    name: 'BeatBox Immortal 300',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1373,
    oldPrice: 4937,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 300. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 337,
    slug: 'beatbox-rockerz-460',
    name: 'BeatBox Rockerz 460',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3487,
    oldPrice: 8118,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 460. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 338,
    slug: 'beatbox-rockerz-450-wonder-woman-dc-edition',
    name: 'BeatBox Rockerz 450 Wonder Woman DC Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1267,
    oldPrice: 2918,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Wonder Woman DC Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 339,
    slug: 'beatbox-rockerz-450-batman-dc-edition',
    name: 'BeatBox Rockerz 450 Batman DC Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1175,
    oldPrice: 4898,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Batman DC Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 340,
    slug: 'beatbox-rockerz-450-superman-dc-edition',
    name: 'BeatBox Rockerz 450 Superman DC Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3139,
    oldPrice: 7967,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Superman DC Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 341,
    slug: 'beatbox-rockerz-450-dc-edition',
    name: 'BeatBox Rockerz 450 DC Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2490,
    oldPrice: 6937,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 DC Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 342,
    slug: 'beatbox-immortal-400',
    name: 'BeatBox Immortal 400',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2357,
    oldPrice: 7469,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 400. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 343,
    slug: 'beatbox-immortal-700',
    name: 'BeatBox Immortal 700',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3896,
    oldPrice: 7449,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 700. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 344,
    slug: 'beatbox-bassheads-950v2',
    name: 'BeatBox Bassheads 950v2',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2756,
    oldPrice: 7349,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Bassheads 950v2. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 345,
    slug: 'beatbox-rockerz-450-iron-man',
    name: 'BeatBox Rockerz 450 Iron Man',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3694,
    oldPrice: 8080,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Iron Man. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 346,
    slug: 'beatbox-rockerz-450-captain-america-marvel-edition',
    name: 'BeatBox Rockerz 450 Captain America Marvel Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1006,
    oldPrice: 2922,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Captain America Marvel Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 347,
    slug: 'beatbox-rockerz-450-black-panther-marvel-edition',
    name: 'BeatBox Rockerz 450 Black Panther Marvel Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2863,
    oldPrice: 7721,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Black Panther Marvel Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 348,
    slug: 'beatbox-immortal-1300',
    name: 'BeatBox Immortal 1300',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3459,
    oldPrice: 6696,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 1300. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 349,
    slug: 'beatbox-rockerz-660',
    name: 'BeatBox Rockerz 660',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1060,
    oldPrice: 4521,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 660. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 350,
    slug: 'beatbox-immortal-200',
    name: 'BeatBox Immortal 200',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2394,
    oldPrice: 7589,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 200. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 351,
    slug: 'beatbox-immortal-1000d',
    name: 'BeatBox Immortal 1000D',
    brand: 'BeatBox',
    category: 'headphones',
    price: 1899,
    oldPrice: 6957,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Immortal 1000D. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 352,
    slug: 'beatbox-rockerz-450-pro',
    name: 'BeatBox Rockerz 450 Pro',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2226,
    oldPrice: 6994,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 450 Pro. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 353,
    slug: 'beatbox-rockerz-650',
    name: 'BeatBox Rockerz 650',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2347,
    oldPrice: 4248,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 650. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 354,
    slug: 'beatbox-nirvanaa-1007anc',
    name: 'BeatBox Nirvanaa 1007ANC',
    brand: 'BeatBox',
    category: 'headphones',
    price: 2524,
    oldPrice: 4857,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Nirvanaa 1007ANC. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 355,
    slug: 'beatbox-rockerz-600-kkr-edition',
    name: 'BeatBox Rockerz 600 KKR Edition',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3378,
    oldPrice: 6712,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 600 KKR Edition. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 356,
    slug: 'beatbox-rockerz-560',
    name: 'BeatBox Rockerz 560',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3153,
    oldPrice: 5533,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 560. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
  ...
  {
    id: 357,
    slug: 'beatbox-rockerz-550',
    name: 'BeatBox Rockerz 550',
    brand: 'BeatBox',
    category: 'headphones',
    price: 3226,
    oldPrice: 6792,
    ...
    description: 'Experience immersive BeatBox Signature Sound with the BeatBox Rockerz 550. Engineered for power, clarity, and deep bass to elevate your listening experience.',
    highlights: [
      'BeatBox Signature Sound',
      'ASAP Fast Charging',
      'Long-lasting Battery Life',
